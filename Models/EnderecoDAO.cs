    ...
    class EnderecoDAO
    {
        ...
        public long Insert(Endereco t)
        {
            try
            {
                ...
                query.CommandText = "INSERT INTO endereco (rua_end, numero_end, bairro_end, cidade_end, estado_end, uf_end, cep_end, pais_end) " +
                    "VALUES (@rua, @numero, @bairro, @cidade, @estado, @uf, @cep, @pais)";
                ...
                query.Parameters.AddWithValue("@estado", "-");
        ...
        public void Update(Endereco t)
        {
            ...
            {
                var query = conn.Query();
                query.CommandText = "UPDATE endereco SET rua_end= @rua, numero_end=@numero, bairro_end=@bairro, cidade_end=@cidade, uf_end=@uf, estado_end=@estado, cep_end=@cep, pais_end=@pais ";
